...
function setup(){
    ...
    box6 = new Box(550,400,58,58);
    box7 = new Boxes(650,400,58,58);
    box8 = new Box(750,400,58,58);
    box9 = new Boxes(850,400,58,58);
    box10 = new Bo(600,350,53,53);
    box11 = new Bo(700,350,53,53);
    box12 = new Boxes(800,350,53,53);
    box13 = new Box(650,300,58,58);
    box14 = new Bo(750,300,58,58);
    box15 = new Boxes(700,250,58,58);
